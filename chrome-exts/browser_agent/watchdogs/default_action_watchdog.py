...
from browser_agent.utils import get_key_info
...
from browser_agent.browser_views import BrowserError, URLNotAllowedError
...
class DefaultActionWatchdog(BaseWatchdog):
	...
	async def _handle_print_button_click(self, element_node: EnhancedDOMTreeNode) -> dict | None:
		...
		try:
			...
			from browser_agent.watchdogs.events import FileDownloadedEvent
