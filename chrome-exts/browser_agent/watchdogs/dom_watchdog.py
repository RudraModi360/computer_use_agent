...
from browser_agent.watchdogs.events import (
	BrowserErrorEvent,
	BrowserStateRequestEvent,
	ScreenshotEvent,
	TabCreatedEvent,
)
from browser_agent.watchdogs.watchdog_base import BaseWatchdog
from browser_agent.dom.service import DomService
from browser_agent.dom.views import (
	EnhancedDOMTreeNode,
	SerializedDOMState,
)
from browser_agent.observability import observe_debug
from browser_agent.utils import create_task_with_error_handling, time_execution_async

if TYPE_CHECKING:
	from browser_agent.browser_views import BrowserStateSummary, NetworkRequest, PageInfo, PaginationButton
...
class DOMWatchdog(BaseWatchdog):
	...
	async def _get_pending_network_requests(self) -> list['NetworkRequest']:
		...
		"""
		from browser_agent.browser_views import NetworkRequest
...
"""
	...
	async def on_BrowserStateRequestEvent(self, event: BrowserStateRequestEvent) -> 'BrowserStateSummary':
		...
		"""
		from browser_agent.browser_views import BrowserStateSummary, PageInfo
	...
	def _detect_pagination_buttons(self, selector_map: dict[int, EnhancedDOMTreeNode]) -> list['PaginationButton']:
		...
		"""
		from browser_agent.browser_views import PaginationButton
	...
	async def _get_page_info(self) -> 'PageInfo':
		...
		from browser_agent.browser_views import PageInfo
